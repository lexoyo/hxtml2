	...
	public function updateSize( width : Int, height : Null<Int> ) {
		...
		if( childs != null ) {
			...
			while( i < count ) {
				...
				// check breakable
				if( d.name == null && lineWidth + d.totalWidth > allowedWidth ) {
