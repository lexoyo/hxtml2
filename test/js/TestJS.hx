...
//	    r.onError = js.Lib.alert;
	...
	static public function onLoaded(htmlData:String):Void{
		...
		try{
			...
			var renderDiv = Lib.document.getElementById("render");
			if (renderDiv == null)
			{
				//throw ("You must have a div with the id 'render' in your html page");
				renderDiv = Lib.document.body;
			}
			renderDiv.appendChild(browser.domRoot);
